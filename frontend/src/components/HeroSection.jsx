    ...
    <section className="bg-slate-900 text-slate-100 py-20 px-4">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg md:text-xl mb-8 transition-all duration-300 hover:text-slate-300">
          Discover the best coffee in town, brewed just for you.
        </p>
        <a href="#menu" className="btn btn-primary py-2 px-4 rounded transition-all duration-300 hover:bg-accent">
          View Menu
        </a>
      </div>
    </section>
